...
export default function FindPeople({ onPreviewClick, showMobileClose, onMobileClose }: FindPeopleProps) {
  ...
  return (
    <div className="flex h-full flex-col bg-white">
      <div className="px-2 py-4 border-b border-slate-100 flex items-center justify-between shrink-0">
      ...
      <div className="border-t border-slate-100 bg-white p-2 sm:p-4 flex items-center justify-between gap-2 shrink-0">
        <button
          onClick={onPreviewClick}
          className="flex flex-1 items-center justify-center gap-1 rounded-lg border border-slate-200 bg-slate-50 hover:bg-slate-100 px-2 py-1.5 sm:px-3 sm:py-2.5 text-[11px] sm:text-xs font-semibold text-slate-700 active:scale-95 transition-all cursor-pointer"
        >
          <Save size={12} className="text-slate-500 sm:size-3" />
          Save Search
        </button>

        <button
          onClick={onPreviewClick}
          className="flex flex-1 items-center justify-center gap-1 rounded-lg bg-slate-900 hover:bg-slate-800 px-2 py-1.5 sm:px-3 sm:py-2.5 text-[11px] sm:text-xs font-semibold text-white active:scale-95 transition-all cursor-pointer shadow-sm"
        >
          <Eye size={12} className="text-white sm:size-3" />
          Preview Result
        </button>
      </div>
    </div>
